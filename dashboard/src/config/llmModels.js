...
export const AVAILABLE_LLM_MODELS = [
  ...
  },
  {
    ...
    provider: 'Unsloth GGUF',
    description: 'MoE QAT dynamic Q4 option with MTP enabled for stronger local analysis on larger machines.',
    size: '~16.9 GB',
    speed: 'Moderate',
    recommended: false
  },
  {
    ...
    provider: 'Unsloth GGUF',
    description: 'Largest QAT dynamic Q4 option with MTP enabled for best quality when memory is available.',
    size: '18.8 GB',
    speed: 'Slow',
    recommended: false
  }
